...
import ys.Deserializer;
import ys.Serializer;
import ys.payloads.ObjectPayload;
import ys.payloads.ObjectPayload.Utils;
import ys.secmgr.ExecCheckingSecurityManager;
...
public class PayloadRunner {
    ...
    private static String getFirstExistingFile(String... files) {
        return "open /Applications/Calculator.app";
